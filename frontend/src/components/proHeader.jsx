    ...
    return (
        <div className="top-bar">
            ...
            <div className="-intro-x breadcrumb ml-auto hidden sm:flex"><a href>اپلیکیشن</a>
                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-chevron-left breadcrumb__icon">
            ...
            <div className="intro-x relative ml-3 sm:ml-6">
                <div className="search hidden sm:block">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-search search__icon dark:text-gray-300">
                        <circle cx={11} cy={11} r={8} />
                        <line x1={21} y1={21} x2="16.65" y2="16.65" />
                    </svg>
                </div>
                <a className="notification sm:hidden" href>
                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-search notification__icon dark:text-gray-300">
                        <circle cx={11} cy={11} r={8} />
                        <line x1={21} y1={21} x2="16.65" y2="16.65" />
                    </svg>
                </a>
                    ...
                    <div className="search-result__content">
                        ...
                        <div className="mb-5">
                            <a href className="flex items-center">
                                <div className="w-8 h-8 bg-theme-18 text-theme-9 flex items-center justify-center rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-inbox w-4 h-4">
                            ...
                            <a href className="flex items-center mt-2">
                                <div className="w-8 h-8 bg-theme-17 text-theme-11 flex items-center justify-center rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-users w-4 h-4">
                            ...
                            <a href className="flex items-center mt-2">
                                <div className="w-8 h-8 bg-theme-14 text-theme-10 flex items-center justify-center rounded-full">
                                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-credit-card w-4 h-4">
                        ...
                        <div className="mb-5">
                            <a href className="flex items-center mt-2">
                                ...
                                <div className="mr-auto truncate text-gray-600 text-xs text-left">denzelwashington@left4code.com
                                </div>
                            </a>
                            <a href className="flex items-center mt-2">
                                <div className="w-8 h-8 image-fit">
                                ...
                                <div className="mr-auto truncate text-gray-600 text-xs text-left">keanureeves@left4code.com</div>
                            </a>
                            <a href className="flex items-center mt-2">
                                <div className="w-8 h-8 image-fit">
                                ...
                                <div className="mr-auto truncate text-gray-600 text-xs text-left">keiraknightley@left4code.com</div>
                            </a>
                            <a href className="flex items-center mt-2">
                                <div className="w-8 h-8 image-fit">
                                    <img alt="Rubick Tailwind HTML Admin Template" className="rounded-full" src="dist\images\profile-8.jpg" />
                                </div>
                                <div className="mr-3">انجلینا جولی</div>
                                <div className="mr-auto truncate text-gray-600 text-xs text-left">angelinajolie@left4code.com</div>
                            </a>
                        </div>
                        ...
                        <a href className="flex items-center mt-2">
                            <div className="w-8 h-8 image-fit">
                                <img alt="Rubick Tailwind HTML Admin Template" className="rounded-full" src="dist\images\preview-12.jpg" />
                            </div>
            ...
            <div className="intro-x dropdown ml-auto sm:ml-6">
                <div className="dropdown-toggle notification notification--bullet cursor-pointer" role="button" aria-expanded="false">
                    <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-bell notification__icon dark:text-gray-300">
                    ...
                    <div className="notification-content__box dropdown-menu__content box dark:bg-dark-6">
                        ...
                        <div className="cursor-pointer relative flex items-center ">
                            ...
                            <div className="mr-2 overflow-hidden">
                                ...
                                <div className="w-full truncate text-gray-600 mt-0.5">لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم
            ...
            <div className="intro-x dropdown w-8 h-8">
                <div className="dropdown-toggle w-8 h-8 rounded-full overflow-hidden shadow-lg image-fit zoom-in" role="button" aria-expanded="false">
                    <img alt="عکس کاربر" src="{{ user.image.url }}" />
                </div>
                <div className="dropdown-menu w-56">
                    <div className="dropdown-menu__content box bg-theme-26 dark:bg-dark-6 text-white">
                        ...
                        <div className="p-2">
                            <a href="{% url 'admin_dashboard_page' %}" className="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-user w-4 h-4 ml-2">
                                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                                    <circle cx={12} cy={7} r={4} />
                                </svg>
                                پروفایل </a>
                            <a href="{% url 'change_password_page' %}" className="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-lock w-4 h-4 ml-2">
                        ...
                        <div className="p-2 border-t border-theme-27 dark:border-dark-3">
                            <a href="{% url 'logout_page' %}" className="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                                <svg xmlns="http://www.w3.org/2000/svg" width={24} height={24} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="feather feather-toggle-right w-4 h-4 ml-2">
