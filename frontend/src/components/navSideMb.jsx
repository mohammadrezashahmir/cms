    ...
    return (
        <div className="mobile-menu md:hidden">
            <div className="mobile-menu-bar">
                ...
                <Link to="javascript:;" id="mobile-menu-toggler"> <i data-feather="bar-chart-2" className="w-8 h-8 text-white transform -rotate-90" />
                </Link>
            </div>
            <ul className="border-t border-theme-29 py-5 hidden">
                ...
                <li>
                    <Link to="javascript:;" className="menu menu--active">
